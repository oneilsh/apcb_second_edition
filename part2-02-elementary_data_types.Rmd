...
This case also serves to demonstrate the benefit of utalizing f-strings: there is no need to case the int as a string! We can use any and all valid Python expressions in them.
