...
We can run the `fasta_stats.py` program (after making it executable with `chmod`) with `./fasta_stats.py pz_cDNAs_sample.fasta`.
...
Based on the information printed, it appears that sequence `PZ7180000031590` has a GC content (percentage of the sequence composed of G or C characters) of 37.9%, is 486 base pairs long, the most common five-base-pair sequence is `ACAAA` (occurring 5 times), and the longest perfect repeat is 10 base pairs long, caused by the pentanucleotide `ATTTA`, occurring twice.
...
# Column 8: Repeat type (dinucleotide, trinucleotide, etc.)
PZ7180000000004_TX	0.279	1000	AAATA	12	unit: TAA	12	trinucleotide
PZ7180000031590	0.379	486	ACAAA	5	unit: ATTTA	10	pentanucleotide</b>
...
[oneils@mbp ~/apcb/intro/fasta_stats]$ <b>ls</b>
<span style="color: green">fasta_stats.py</span>  pz_cDNAs_sample.fasta    pz_sample_stats.txt
...
Working with the cleaned data table reveals that our program produced 28,194 characters broken into 4,239 words among 471 lines of data output.
...
<pre id=part1-09-pipe
     class="language-txt 
            ...
            linkable-line-numbers">
<code>
[oneils@mbp ~/apcb/intro/fasta_stats]$ <b>rm pz_stats.table</b>
<span style="color: green">fasta_stats.py</span>  pz_cDNAs_sample.fasta    pz_sample_stats.txt
...
<pre id=part1-09-pipe-line
     class="language-txt 
            ...
            linkable-line-numbers">
<code>
[oneils@mbp ~/apcb/intro/fasta_stats]$ <b>./fasta_stats.py pz_cDNAs.fasta | grep 'unit:' | wc</b>
</code></pre>
...
<pre id=part1-09-pipe-line
     class="language-txt 
            ...
            linkable-line-numbers">
<code>
[oneils@mbp ~/apcb/intro/fasta_stats]$ <b>./fasta_stats.py pz_cDNAs.fasta | \</b>
...
<pre id=part1-09-AT-grep-output
     class="language-txt 
            ...
            linkable-line-numbers">
<code>
<b>PZ7180000031590	0.379	486	ACAAA	5	unit: ATTTA	10	pentanucleotide
PZ15501_A	0.166	163	AATTA	7	unit: ATT	6	trinucleotide
PZ7180000027936	0.22	273	TTTTT	10	unit: ATAAA	10	pentanucleotide
PZ7180000024037	0.277	1462	TTTTT	36	unit: ATTGTGG	14	heptanucleotide
PZ456919	0.287	143	ATACA	4	unit: ATAC	8	tetranucleotide
PZ7180000024719_APV	0.306	1074	ATTAT	11	unit: ATT	6	trinucleotide
...</b>
</code></pre>
...
<pre id=part1-09-grep-grep-output
     class="language-txt 
            ...
            linkable-line-numbers">
<code>
<b>PZ7180000031598 0.21    81      AATAT   5       unit: AT        6       dinucleotide
PZ23512_A       0.281   153     TTAAA   3       unit: AT        6       dinucleotide
PZ851952        0.399   338     TATAT   12      unit: AT        24      dinucleotide
PZ17053_A       0.21    119     ATTAA   6       unit: AT        4       dinucleotide
PZ463243        0.227   97      TTGTA   3       unit: AT        4       dinucleotide
PZ22254_A       0.132   68      ATTAA   5       unit: AT        4       dinucleotide
...</b>
</code></pre>
...
The above script will need to be made executable and placed in a location referenced by `$PATH`, as will the `fasta_stats.py` program.
