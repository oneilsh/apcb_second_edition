...
<code>
[soneil@mbp ~]$ <b>jupyter notebook</b>
</code></pre>
...
<pre id=block_10949d
     class="language-txt 
            ...
            linkable-line-numbers">
<code>
[soneil@mbp ~]$ <b>nano -w -i -E -T 4 helloworld.py</b>
</code></pre>
...
<pre id=block_a995fb
     class="language-txt 
            ...
            linkable-line-numbers">
<code>
[soneil@mbp ~]$ <b>python helloworld.py</b>
Hello world!
</code></pre>
...
An alternative method is to make the code file an executable [script](#script_def). First, we have to edit the code file to include a special first line:
...
<pre id=block_ef3a01
     class="language-txt 
            ...
            linkable-line-numbers">
<code>
[soneil@mbp ~]$ <b>echo "alias nanopy='nano -w -i -E -T 4 ' >> ~/.bashrc"</b>
</code></pre>
